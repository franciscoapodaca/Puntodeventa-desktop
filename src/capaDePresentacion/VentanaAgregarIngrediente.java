 ...
 * @author Francisco
 */
public class VentanaAgregarIngrediente extends javax.swing.JFrame {
    ...
    AdministrarIngredientes admIng = new AdministrarIngredientes();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese los datos del Ingrediente:");
        ...
        getContentPane().add(botonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 270, 210, 90));
        ...
        getContentPane().add(botonAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 200, 70));
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        if (txtNombre.getText().trim().length() == 0 || txtCantidad.getText().trim().length() == 0) {
            JOptionPane.showMessageDialog(this, "VERIFIQUE QUE NO EXISTAN CAMPOS VACIOS");
        } else {
            ingrediente.setNombre(txtNombre.getText());
            ingrediente.setExistencia(Double.parseDouble(txtCantidad.getText()));
            try {
                facade.agregarIngrediente(ingrediente);
                JOptionPane.showMessageDialog(null, "Ingrediente Agregado");
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "ERROR AL AGREGAR EL INGREDIENTE ", "¡ERROR!", 0);
            }
        }
