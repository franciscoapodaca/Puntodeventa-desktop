 ...
 * @author Z470
 */
public class VentanaVentaUsuarioSimple extends javax.swing.JFrame {
     ...
     */
    public VentanaVentaUsuarioSimple() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonRegresarMenuPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 660, -1, 70));

        etiquetaCambio.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        etiquetaCambio.setText("CAMBIO: $");
        getContentPane().add(etiquetaCambio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, -1, -1));
        ...
        getContentPane().add(botonPreparado, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 440, 260, 70));
        ...
        getContentPane().add(botonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 620, 290, 90));
        ...
        getContentPane().add(botonVender, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 610, 280, 110));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, 340, 330));
        ...
        getContentPane().add(botonBebida, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 430, 260, 80));
        ...
        getContentPane().add(etiquetaFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 990, 780));
    ...
    private void botonPreparadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPreparadoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(VentanaVentaUsuarioSimple.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void botonVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonVenderActionPerformed
        int response = JOptionPane.showConfirmDialog(null, "Esta seguro que desea vender ?", "Confirmar Venta",
...
//        }
    ...
    private void botonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCancelarActionPerformed
        costoVenta = 0.0;
        int response = JOptionPane.showConfirmDialog(null, "¿ Esta seguro que desea Cancelar la venta ?", "Cancelar",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (response == JOptionPane.YES_OPTION) {
            VentanaVentaUsuarioSimple.modelo.removeAllElements();
            VentanaVentaUsuarioSimple.txtTotal.setText("");
    ...
    private void botonRegresarMenuPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRegresarMenuPrincipalActionPerformed
        ...
        if (response == JOptionPane.YES_OPTION) {
            this.dispose();
            VentanaPrincipalSistemaUsuarioSimple vps;
            vps = new VentanaPrincipalSistemaUsuarioSimple();
            vps.setVisible(true);
        }
